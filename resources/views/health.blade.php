        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 col-xl-4">
                    <div class="blog-box">
                        <div class="blog-img">
                            <img class="img-fluid" src="images/health/he1.png" alt="" />
                        </div>
                        <div class="blog-content">
                            <div class="title-blog">
                                <h3><center>Regular Check-ups</center></h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 col-xl-4">
                    <div class="blog-box">
                        <div class="blog-img">
                            <img class="img-fluid" src="images/health/he2.png" alt="" />
                        </div>
                        <div class="blog-content">
                            <div class="title-blog">
                                <h3><center>Have a healthy lifestyle</center></h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 col-xl-4">
                    <div class="blog-box">
                        <div class="blog-img">
                            <img class="img-fluid" src="images/health/he3.png" alt="" />
                        </div>
                        <div class="blog-content">
                            <div class="title-blog">
                                <h3><center>Get Treatment</center></h3>
                            </div>
                        </div>
                    </div>
                </div>
