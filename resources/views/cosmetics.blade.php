...
<body>
    ...
    <!-- End Top Search -->
<!-- Start All Title Box -->
<div class="all-title-boxcosmetic">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h2>C O S M E T I C S</h2>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="container">
            ...
            <div class="row special-list">
                <div class="col-lg-3 col-md-6 special-grid best-seller">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            <img src="images/cosmetics/cos3.png" class="img-fluid" alt="Image">
                        </div>
                        <div class="why-text">
                            <h5><center>Eyeshadow</center></h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 special-grid top-featured">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            <img src="images/cosmetics/cos2.png" class="img-fluid" alt="Image">
                        </div>
                        <div class="why-text">
                            <h5><center>Foundation</center></h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 special-grid top-featured">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            <img src="images/cosmetics/cos1.png" class="img-fluid" alt="Image">
                        </div>
                        <div class="why-text">
                            <h5><center>Lipstik</center></h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 special-grid best-seller">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            <img src="images/cosmetics/cos4.png" class="img-fluid" alt="Image">
                        </div>
                        <div class="why-text">
                            <h5><center>Blush On</center></h5>
                        </div>
                    </div>
                </div>
            </div>
