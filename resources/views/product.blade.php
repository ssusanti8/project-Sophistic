                                        ...
                                        <div class="col-menu col-md-3">
                                            ...
                                            <div class="content">
                                                <ul class="menu-col">
                                                    ...
                                                    <li><a href="/product">Sweaters & Cardigans</a></li>
                                        ...
                                        <div class="col-menu col-md-3">
                                            ...
                                            <div class="content">
                                                <ul class="menu-col">
                                                    ...
                                                    <li><a href="/product">Skirts</a></li>
                                                    <li><a href="/product">Jeans</a></li>
                                                    <li><a href="/product">Trousers</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <!-- end col-3 -->
                                        <div class="col-menu col-md-3">
                                            ...
                                            <div class="content">
                                                <ul class="menu-col">
                                                    ...
                                                    <li><a href="/product">Party wear</a></li>
                                                    <li><a href="/product">Bottom Wear</a></li>
                                                    <li><a href="/product">Indian Wear</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="col-menu col-md-3">
